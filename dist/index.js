...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/polyfill */ \"@babel/polyfill\");\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _organisms_list_events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./organisms/list_events */ \"./src/js/organisms/list_events.js\");\n // import Promise from 'bluebird';\n\n\nObject(_organisms_list_events__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _molecules_google_calendar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../molecules/google_calendar */ \"./src/js/molecules/google_calendar/index.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"google\", function() { return _molecules_google_calendar__WEBPACK_IMPORTED_MODULE_0__[\"google\"]; });\n\n/* harmony import */ var _fetch_client_secret__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fetch_client_secret */ \"./src/js/organisms/google_calendar/fetch_client_secret.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"fetchClientSecret\", function() { return _fetch_client_secret__WEBPACK_IMPORTED_MODULE_1__[\"default\"]; });\n\n/* harmony import */ var _list_events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list_events */ \"./src/js/organisms/google_calendar/list_events.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"listEvents\", function() { return _list_events__WEBPACK_IMPORTED_MODULE_2__[\"default\"]; });\n\n/* harmony import */ var _with_authorize__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./with_authorize */ \"./src/js/organisms/google_calendar/with_authorize.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"withAuthorize\", function() { return _with_authorize__WEBPACK_IMPORTED_MODULE_3__[\"default\"]; });\n\n\n\n\n\n\n\n//# sourceURL=webpack:///./src/js/organisms/google_calendar/index.js?");
...
/***/ "./src/js/organisms/google_calendar/with_authorize.js":
/*!************************************************************!*\
  !*** ./src/js/organisms/google_calendar/with_authorize.js ***!
  \************************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _molecules_google_calendar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../molecules/google_calendar */ \"./src/js/molecules/google_calendar/index.js\");\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (_molecules_google_calendar__WEBPACK_IMPORTED_MODULE_0__[\"withAuthorize\"]);\n\n//# sourceURL=webpack:///./src/js/organisms/google_calendar/with_authorize.js?");

/***/ }),

/***/ "./src/js/organisms/list_events.js":
/*!*****************************************!*\
  !*** ./src/js/organisms/list_events.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/polyfill */ \"@babel/polyfill\");\n/* harmony import */ var _babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _google_calendar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./google_calendar */ \"./src/js/organisms/google_calendar/index.js\");\n // import Promise from 'bluebird';\n\n // TODO: config に移動\n\nvar CLIENT_SECRET_PATH = 'client_secret.json';\n\nvar listEvent = function listEvent() {\n  var clientSecretPath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : CLIENT_SECRET_PATH;\n  Object(_google_calendar__WEBPACK_IMPORTED_MODULE_1__[\"fetchClientSecret\"])(clientSecretPath, 'installed').then(function (credentials) {\n    // eslint-disable-next-line no-console\n    console.log('fetchClientSecret then'); // eslint-disable-next-line no-console\n\n    console.log('before listEvents');\n    return Object(_google_calendar__WEBPACK_IMPORTED_MODULE_1__[\"listEvents\"])(credentials);\n  }).then(function (events) {\n    // NOTE: ひとまず，console.log出力とする\n    //       本来であれば，この出力を Dialogflow に渡す\n    // eslint-disable-next-line no-console\n    console.log('fetched event'); // eslint-disable-next-line no-console\n\n    console.log(events);\n  }).catch(function (err) {\n    // eslint-disable-next-line no-console\n    console.log('error'); // eslint-disable-next-line no-console\n\n    console.log(err);\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (listEvent);\n\n//# sourceURL=webpack:///./src/js/organisms/list_events.js?");
